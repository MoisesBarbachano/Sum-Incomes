...
ActiveRecord::Schema.define(version: 2020_11_09_054603) do
  ...
  create_table "incomes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.float "quantity_items"
    t.bigint "buyer_id", null: false
    t.bigint "seller_id", null: false
    t.bigint "item_id", null: false
    t.index ["buyer_id"], name: "index_incomes_on_buyer_id"
    t.index ["item_id"], name: "index_incomes_on_item_id"
    t.index ["seller_id"], name: "index_incomes_on_seller_id"
  end
  ...
  add_foreign_key "incomes", "buyers"
  add_foreign_key "incomes", "items"
  add_foreign_key "incomes", "sellers"
end
